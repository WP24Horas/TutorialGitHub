...
if(!class_exists('QCTHG_Main'))
{
    class QCTHG_Main
    {
        ...
        {
            register_activation_hook(QCTHG_SLUG_PATH, array('QCTHG_Main', 'qcthgActivate'));
            register_deactivation_hook(QCTHG_SLUG_PATH, array('QCTHG_Main', 'qcthgDeactivate'));
            register_uninstall_hook(QCTHG_SLUG_PATH, array('QCTHG_Main', 'qcthgUninstall'));
